        ...
        public Deployer(InternalConsole internalConsole)
        {
            ...
            StoredApplications = new List<Application>
            {
                new DotNetApplication
                {
                    ...
                    Title = "Payroll",
                    WorkingDirectory = "D:\\pipelinetest\\",
                    SourceCodeFolder = "Payroll-Temp-Src-Code",
                    EndpointFolder = "FlairsPayroll",
                    SecretsFolder = "Secrets",
                    BackupFolder = "Payroll-Backup",
                    OutputFolder = "Payroll-Output",
